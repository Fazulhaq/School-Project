  ...
  return (
    <div>
      <h2 id="parent-heading" data-cy="ParentHeading">
        <Translate contentKey="schoolMisApp.parent.home.title">Parents</Translate>
        <div className="d-flex justify-content-end">
          <Link to="/parent/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="schoolMisApp.parent.home.createLabel">Create new Parent</Translate>
          </Link>
        </div>
      </h2>
        ...
        {parentList && parentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="schoolMisApp.parent.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="schoolMisApp.parent.home.notFound">No Parents found</Translate>
            </div>
          )
        )}
      </div>
