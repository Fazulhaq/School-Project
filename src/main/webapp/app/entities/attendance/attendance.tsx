...
export const Attendance = () => {
  ...
  const breadcrumbItems = [{ label: 'Attendances', url: '' }];

  return (
    <div>
      <DynamicBreadcrumb items={breadcrumbItems} />
      <h2 id="attendance-heading" data-cy="AttendanceHeading">
        {/* <Translate contentKey="schoolMisApp.attendance.home.title">Attendances</Translate> */}
        <div className="d-flex justify-content-end">
          <Link to="/attendance/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="schoolMisApp.attendance.home.createLabel">Create new Attendance</Translate>
          </Link>
        </div>
      </h2>
        ...
        {attendanceList && attendanceList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="schoolMisApp.attendance.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="schoolMisApp.attendance.student">Student</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {attendanceList.map((attendance, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`schoolMisApp.AttendanceStatus.${attendance.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="schoolMisApp.attendance.home.notFound">No Attendances found</Translate>
            </div>
          )
        )}
      </div>
