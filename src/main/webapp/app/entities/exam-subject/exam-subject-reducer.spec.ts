...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXAMSUBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXAMSUBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXAMSUBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EXAMSUBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EXAMSUBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXAMSUBJECT actions', async () => {
      const arg = 42666;
