...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEESTRUCTURE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FEESTRUCTURE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FEESTRUCTURE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FEESTRUCTURE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FEESTRUCTURE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FEESTRUCTURE actions', async () => {
      const arg = 42666;
