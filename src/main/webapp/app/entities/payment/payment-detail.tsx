...
export const PaymentDetail = () => {
  ...
  const paymentEntity = useAppSelector(state => state.payment.entity);
   ...
   const breadcrumbItems = [
    ...
    { label: "View Payment Details", url: '' },
  ];
    ...
    <Row>
      ...
      <Col md="8">
        <h2 data-cy="paymentDetailsHeading">
          <Translate contentKey="schoolMisApp.payment.detail.title">Payment</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="schoolMisApp.payment.student">Student</Translate>
          </dt>
          <dd>{paymentEntity.student ? paymentEntity.student.id : ''}</dd>
        </dl>
