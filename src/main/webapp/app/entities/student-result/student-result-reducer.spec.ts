...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTRESULT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDENTRESULT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDENTRESULT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STUDENTRESULT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTRESULT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDENTRESULT actions', async () => {
      const arg = 42666;
