...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEACHERSUBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TEACHERSUBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TEACHERSUBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TEACHERSUBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TEACHERSUBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TEACHERSUBJECT actions', async () => {
      const arg = 42666;
