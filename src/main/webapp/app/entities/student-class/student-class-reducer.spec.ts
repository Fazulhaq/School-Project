...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTCLASS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDENTCLASS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDENTCLASS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STUDENTCLASS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTCLASS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDENTCLASS actions', async () => {
      const arg = 42666;
