...
export const Subject = () => {
  ...
  const getSortIconByFieldName = (fieldName: string) => {
   ...
   const breadcrumbItems = [{ label: 'Subjects', url: '' }];

  return (
    <div>
      <DynamicBreadcrumb items={breadcrumbItems} />
      <h2 id="subject-heading" data-cy="SubjectHeading">
        {/* <Translate contentKey="schoolMisApp.subject.home.title">Subjects</Translate> */}
        <div className="d-flex justify-content-end">
          <Link to="/subject/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="schoolMisApp.subject.home.createLabel">Create new Subject</Translate>
          </Link>
        </div>
      </h2>
        ...
        {subjectList && subjectList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="schoolMisApp.subject.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="schoolMisApp.subject.home.notFound">No Subjects found</Translate>
            </div>
          )
        )}
      </div>
