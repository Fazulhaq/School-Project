...
export const Teacher = () => {
  ...
  const breadcrumbItems = [{ label: 'Teachers', url: '' }];

  return (
    <div>
      <DynamicBreadcrumb items={breadcrumbItems} />
      <h2 id="teacher-heading" data-cy="TeacherHeading">
        {/* <Translate contentKey="schoolMisApp.teacher.home.title">Teachers</Translate> */}
        <div className="d-flex justify-content-end">
          <Link to="/teacher/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="schoolMisApp.teacher.home.createLabel">Create new Teacher</Translate>
          </Link>
        </div>
      </h2>
        ...
        {teacherList && teacherList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="schoolMisApp.teacher.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('qualification')}>
                  ...
                  <FontAwesomeIcon icon={getSortIconByFieldName('qualification')} />
                </th>
                <th>
                  <Translate contentKey="schoolMisApp.teacher.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {teacherList.map((teacher, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{teacher.hireDate ? <TextFormat type="date" value={teacher.hireDate} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="schoolMisApp.teacher.home.notFound">No Teachers found</Translate>
            </div>
          )
        )}
      </div>
