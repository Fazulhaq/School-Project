...
import static com.mcit.schoolmis.domain.PaymentAsserts.*;
...
import com.mcit.schoolmis.domain.Payment;
import com.mcit.schoolmis.domain.enumeration.PaymentMethod;
import com.mcit.schoolmis.repository.PaymentRepository;
...
class PaymentResourceIT {
    ...
    private static final PaymentMethod UPDATED_METHOD = PaymentMethod.BANK;
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().amount(UPDATED_AMOUNT).paymentDate(UPDATED_PAYMENT_DATE).method(UPDATED_METHOD);
        return payment;
    }
